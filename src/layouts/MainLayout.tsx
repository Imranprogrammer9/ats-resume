...
function AnnouncementBar() {
  return (
    <div className="overflow-hidden flex items-center py-2.5" style={{ background: 'var(--forest)' }}>
      <span
        className="whitespace-nowrap text-xs font-semibold tracking-wide animate-marquee-single"
        style={{ color: 'var(--brass-light)' }}
      >
        🎯 Early Bird — ATS-Ready CV with Gap Analysis Only $25 · Limited Spots
      </span>
    </div>
  );
}
...
export default function MainLayout() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        href="https://api.whatsapp.com/send/?phone=923312935551&text&type=phone_number&app_absent=0"
        target="_blank"
